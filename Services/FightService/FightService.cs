    ...
    public class FightService : IFightService
    {
        ...
        public async Task<ServiceResponse<AttackResultDto>> SkillAttack(SkillAttackDto request)
        {
            ...
            try
            {
                ...
                CharacterSkill characterSkill = attacker.CharacterSkill.FirstOrDefault(cs => cs.Skill.Id == request.SkillId);
                ...
                while (!defeated)
                {
                    foreach (Character attacker in characters)
                    {
                        ...
                        else
                        {
                            ...
                            damage = DoSkillAttack(attacker, opponent, attacker.CharacterSkill[randomSkill]);
                        }
